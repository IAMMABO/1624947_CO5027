...
<asp:Content ID ="Content1" ContentPlaceHolderID="CPH1" runat ="server">
    ...
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="Prod_ID" DataSourceID="SqlDataSource1">
        <EditItemTemplate>
            ...
            <ul>
            <li>>Prod_ID:
            <asp:Label ID="Prod_IDLabel1" runat="server" Text='<%# Eval("Prod_ID") %>' /></li>
            
            <li>Prod_Name:
            <asp:TextBox ID="Prod_NameTextBox" runat="server" Text='<%# Bind("Prod_Name") %>' /></li>
            
            <li>Prod_Price:
            <asp:TextBox ID="Prod_PriceTextBox" runat="server" Text='<%# Bind("Prod_Price") %>' /></li>
            
            <li>Prod_Quantity:
            <asp:TextBox ID="Prod_QuantityTextBox" runat="server" Text='<%# Bind("Prod_Quantity") %>' /></li>
                </ul>
        ...
        <InsertItemTemplate>
            ...
            <tr>
                ...
                <ul>
            <li>Prod_ID:
            <asp:TextBox ID="Prod_IDTextBox" runat="server" Text='<%# Bind("Prod_ID") %>' /></li>
        ...
        <ItemTemplate>
            ...
            <li>
            Prod_ID:
            <asp:Label ID="Prod_IDLabel" runat="server" Text='<%# Eval("Prod_ID") %>' /></li>
           
            <li>Prod_Name:
            <asp:Label ID="Prod_NameLabel" runat="server" Text='<%# Bind("Prod_Name") %>' /></li>
            
            <li>Prod_Price:
            <asp:Label ID="Prod_PriceLabel" runat="server" Text='<%# Bind("Prod_Price") %>' /></li>
            
            <li>Prod_Quantity:
            <asp:Label ID="Prod_QuantityLabel" runat="server" Text='<%# Bind("Prod_Quantity") %>' /></li>
                </ul>
            </td>
                  </tr>
            </table>
