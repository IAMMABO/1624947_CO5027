...
<asp:Content ID ="Content2" ContentPlaceHolderID="CPH1" runat ="server">
    <form id = "form1" runat = "server">
        ...
        <h1>Edit Product Here</h1>
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="Prod_ID" DataSourceID="SqlDataSource" Width="323px" Height="200px">
                <EditItemTemplate>
                    Prod_ID:
            ...
            <asp:SqlDataSource ID="SqlDataSource" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:db_1624947_beanbagConnectionString %>" DeleteCommand="DELETE FROM [tbl_products] WHERE [Prod_ID] = @original_Prod_ID AND [Prod_Name] = @original_Prod_Name AND [Prod_Price] = @original_Prod_Price AND (([Prod_Quantity] = @original_Prod_Quantity) OR ([Prod_Quantity] IS NULL AND @original_Prod_Quantity IS NULL))" InsertCommand="INSERT INTO [tbl_products] ([Prod_ID], [Prod_Name], [Prod_Price], [Prod_Quantity]) VALUES (@Prod_ID, @Prod_Name, @Prod_Price, @Prod_Quantity)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [tbl_products] WHERE ([Prod_ID] = @Prod_ID)" UpdateCommand="UPDATE [tbl_products] SET [Prod_Name] = @Prod_Name, [Prod_Price] = @Prod_Price, [Prod_Quantity] = @Prod_Quantity WHERE [Prod_ID] = @original_Prod_ID AND [Prod_Name] = @original_Prod_Name AND [Prod_Price] = @original_Prod_Price AND (([Prod_Quantity] = @original_Prod_Quantity) OR ([Prod_Quantity] IS NULL AND @original_Prod_Quantity IS NULL))">
                <DeleteParameters>
